...
(function ($) {
    ...
    function history_img() {
        ...
        if (width >= 992) {
            ...
            $(".history-section .img-block").css({
                "background-image": "url('" + history_image + "')",
                "height": history_content_height
            });
        } else {
            $(".history-section .img-block").removeAttr("style");
            $(".history-section .img-block img").remove();
    ...
    function event_img_block() {
        ...
        if (width >= 992) {
            ...
            $(".event-section2 .event-img-block").css({
        ...
        if (width >= 992) {
            ...
            $(".event-section2 .event-img-block").css({
                "padding-top": event_img_content_padding,
                "padding-bottom": event_img_content_padding
            });
        } else {
            $(".event-section2 .event-img-block").removeAttr("style");
        }
    ...
    function loadModules() {
        ...
        var suffix = ""
        if (href.indexOf("/bjtf/") >= 0) {
            suffix = "/bjtf";
        }
        $('#header-wrap').load(suffix + '/modules/header.html',function(){
            initModules();
        });
